...
#blackout_houses_OLD <- houses[blackout_houses_index, ]
...
```{r}
# Crop texas income dtaa to the Houston area
...
census_homes_cropped <- st_filter(tx_income_census, homes_blackout)
